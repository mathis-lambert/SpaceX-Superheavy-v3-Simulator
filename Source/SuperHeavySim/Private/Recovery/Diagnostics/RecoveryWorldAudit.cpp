...
void ARecoveryPlayerController::TickWorldAudit()
{
    ...
    case 2: Menu->ShowPage(ERecoveryMenuPage::Display);Shot(TEXT("Display.png"));AuditDeadline=Now+2;break;
    ...
    case 10: bAtHome=false;SetMenuVisible(false);D->Viewer->SetCameraMode(4);AuditDeadline=Now+4;break;
    case 11: Shot(TEXT("Conditioning.png"));AuditDeadline=Now+2;break;
    case 12: LaunchFlight();D->Viewer->SetCameraMode(0);AuditDeadline=Now+FRecoveryLaunchSequence::DurationS+13;break;
    ...
    case 17:
        ...
        SetPlaybackRate(1);ReturnHome();SetHardwareRayTracing(true);Menu->ShowPage(ERecoveryMenuPage::RayTracing);AuditDeadline=Now+8;break;
    case 18:
