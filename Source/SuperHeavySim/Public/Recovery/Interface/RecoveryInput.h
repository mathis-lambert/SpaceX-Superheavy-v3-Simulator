...
{
    enum class EAction : uint8 { Pause, Cameras, NextCamera, FreeCamera, Telemetry, Inspect, Computer, Slower, Faster, Start };
    ...
    inline const TArray<FBinding>& Bindings()
    {
        static const TArray<FBinding> Values={
            ...
            {EKeys::L,EAction::Computer,TEXT("Flight computer")},
