...
DEST=ART_ROOT/'Earth'/'Detail4000'
...
def fetch_tile(tile):
    ...
    parameters=dict(bbox=','.join(map(str,bbox)),bboxSR=4326,imageSR=4326,size='4000,4000',format='png32',bandIds='0,1,2',f='image')
    ...
    return dict(file=path.name,url=url,bbox=bbox,dimensions=[4000,4000],nominal_output_metres_per_pixel=3000/4000,sha256=hashlib.sha256(path.read_bytes()).hexdigest())
